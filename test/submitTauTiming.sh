...
for dir in DYJetsToLL_200PU DYJetsToLL_0PU #TTBar-RelVal-0  TTBar-RelVal-140  TTBar-RelVal-200 ZTT-RelVal-0  ZTT-RelVal-140   ZTT-RelVal-200  QCDMuEnriched_realistic
do 
    echo " "
    echo "====================" $dir "========================="
